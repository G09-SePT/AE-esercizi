 ...
 * Claudio Bertoncello		1999.10 	add methods for to convert Mic1Instruction
 *							in a number in base 16 and viceversa
 */
...
public class Mic1Instruction
{
	...
	public long toHex()
	{
		...
		bitGroup1 = (NEXT_ADDRESS >> 5) & 0x000F;

		bitGroup2 = (NEXT_ADDRESS >> 1) & 0x000F;

		bitGroup3 = (NEXT_ADDRESS & 0x0001) << 3;
		if (JMPC == true) bitGroup3 = bitGroup3 | 0x4;
		if (JAMN == true) bitGroup3 = bitGroup3 | 0x2;
		if (JAMZ == true) bitGroup3 = bitGroup3 | 0x1;

		if (SLL8 == true) bitGroup4 = bitGroup4 | 0x8;
		if (SRA1 == true) bitGroup4 = bitGroup4 | 0x4;
		if (F0 == true) bitGroup4 = bitGroup4 | 0x2;
		if (F1 == true) bitGroup4 = bitGroup4 | 0x1;

		if (ENA == true) bitGroup5 = bitGroup5 | 0x8;
		if (ENB == true) bitGroup5 = bitGroup5 | 0x4;
		if (INVA == true) bitGroup5 = bitGroup5 | 0x2;
		if (INC == true) bitGroup5 = bitGroup5 | 0x1;

		if (H == true) bitGroup6 = bitGroup6 | 0x8;
		if (OPC == true) bitGroup6 = bitGroup6 | 0x4;
		if (TOS == true) bitGroup6 = bitGroup6 | 0x2;
		if (CPP == true) bitGroup6 = bitGroup6 | 0x1;

		if (LV == true) bitGroup7 = bitGroup7 | 0x8;
		if (SP == true) bitGroup7 = bitGroup7 | 0x4;
		if (PC == true) bitGroup7 = bitGroup7 | 0x2;
		if (MDR == true) bitGroup7 = bitGroup7 | 0x1;

		if (MAR == true) bitGroup8 = bitGroup8 | 0x8;
		if (WRITE == true) bitGroup8 = bitGroup8 | 0x4;
		if (READ == true) bitGroup8 = bitGroup8 | 0x2;
		if (FETCH == true) bitGroup8 = bitGroup8 | 0x1;

		bitGroup9 = B;


		long hexCode = ((long) bitGroup1 << 32)
				| ((long) bitGroup2 << 28)
				| ((long) bitGroup3 << 24)
				| ((long) bitGroup4 << 20)
				| ((long) bitGroup5 << 16)
