...
// System.out.println( "char = " + t ) ;
		...
		{
			case ';':
				return new Symbol(Mic1Symbol.SEMI);
			case '+':
				return new Symbol(Mic1Symbol.PLUS);
			case '-':
				return new Symbol(Mic1Symbol.MINUS);
			case '<':
				return new Symbol(Mic1Symbol.LESSTHAN);
			case '=':
				return new Symbol(Mic1Symbol.EQUALS);
			case '>':
				return new Symbol(Mic1Symbol.GREATERTHAN);
			case '(':
				return new Symbol(Mic1Symbol.LPAREN);
			case ')':
				return new Symbol(Mic1Symbol.RPAREN);
			default:
